...
<body>
    ...
    <form action="#" method="POST">
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0" id='navt'>
                    ...
                    <a href="add_author.php" class="nav-item nav-link"><i class="fa-solid fa-plus"></i>&nbsp;Add Author</a>
                    <a href="add_editeur.php" class="nav-item nav-link"><i class="fa-solid fa-plus"></i>&nbsp;Add Editeur</a>
                    <a href="add_examplaire.php" class="nav-item nav-link"><i class="fa-solid fa-plus"></i>&nbsp;Add examplaire</a>
                    <a href="add_them.php" class="nav-item nav-link"><i class="fa-solid fa-plus"></i>&nbsp;Add Them</a>

                    <a href="add_book.php" class="nav-item nav-link"><i class="fa-solid fa-trash"></i>&nbsp;Delete</a>
  ...
  <!-- navbar end -->
        ...
        <center>
        <?php 
            $table=$pdo->query("SELECT * FROM student");

...
<body>
    <?php
        ...
        if(isset($_POST['send'])){
            ...
            if(isset($message)!="" && $message!=""){
                $pdo->query("INSERT INTO message VALUES(null, '$cinE', '$fandl', '$message', NOW())");
    ...
    <script>
      ...
      <style>
        ...
        .you{
            background-color: #1876f229;
        }
        .them{
            border: 1px solid #ffab03;
            background-color: #ffab0321;
            margin-right: 10px;
        }
        .you span{
            font-weight: bold;
        ...
        .them span{
            ...
            font-size: 18px;
            color: #bb7d02;
            border-bottom: 1px solid #dfbc0d;
